...
![Figure 1: Clustering in two stage sampling](pics/cluster.png){fig-alt="Schematic representation of sample clustering"}
...
![Figure 2: An example of stratified sampling](pics/strata.png){fig-alt="Schematic representation of sample stratification"}
...
![LFS design factors](pics/lfs_vol1_SE.png){fig-alt="Screenshot of LFS documentation Volume 1, Annex C showing Design Effects"}
